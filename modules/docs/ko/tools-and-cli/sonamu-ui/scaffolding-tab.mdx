...
<Columns cols={2}>
  <Frame>
    <img src="/images/sonamuUI-scaffolding1.png" alt="Scaffolding 선택" />
  </Frame>
  <Frame>
    <img src="/images/sonamuUI-scaffolding2.png" alt="Scaffolding 옵션" />
  </Frame>
</Columns>

<Columns cols={2}>
  <Frame>
    <img src="/images/sonamuUI-scaffolding3.png" alt="Scaffolding 생성 결과" />
  </Frame>
  <Frame>
    <img src="/images/sonamuUI-scaffolding4.png" alt="Scaffolding 완료" />
  </Frame>
</Columns>
...
<Info>
  View 컴포넌트 생성 기능은 현재 개발 중입니다. **Sonamu UI의 다른 기능**을 통해 React 컴포넌트를
  생성할 수 있습니다.
</Info>
...
<Warning>
  **코드 손실 주의**: 기존 파일을 덮어쓰면 작성한 비즈니스 로직이 삭제될 수 있습니다. 커스터마이징한
...
<CardGroup cols={2}>
  ...
  <Card title="scaffold CLI" icon="terminal" href="/ko/tools-and-cli/sonamu-cli/scaffold">
    CLI로 코드 생성하기
  </Card>
</CardGroup>
