...
자세한 내용은 [Advanced Patterns](/database/puri/advanced-patterns) 참고
</Warning>
...
복잡한 집계는 [Aggregations](/database/puri/aggregations) 참고
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Aggregations" icon="calculator" href="/database/puri/aggregations">
    집계 함수 사용하기
  </Card>
