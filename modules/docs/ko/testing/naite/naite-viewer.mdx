...
<Frame>
  <img src="/images/naite-viewer-open-panel.png" alt="VSCode에서 Naite Viewer 패널 열기" />
  <p>Command Palette에서 'Naite: Open Viewer'를 실행하여 패널을 여는 모습</p>
</Frame>
...
<Frame>
  <img src="/images/naite-viewer-main-screen.png" alt="Naite Viewer 메인 화면" />
  <p>실제 Naite Viewer에서 테스트 로그가 표시되는 모습 (Suite > Test > Trace 계층 구조)</p>
</Frame>
...
<Frame>
  <img src="/images/naite-viewer-callstack.png" alt="Naite Viewer 콜스택 상세 정보" />
  <p>로그를 클릭했을 때 표시되는 콜스택 정보와 코드 위치로 이동하는 기능</p>
</Frame>
