...
<CardGroup cols={2}>
  ...
  <Card title="자동 롤백" icon="rotate-left">
    Transaction 기반 테스트 후 자동 정리
  </Card>
  <Card title="Fixture 지원" icon="database">
    실제 데이터 복사 일관된 테스트 환경
  </Card>
...
- `test`와 `production`는 **절대 같은 DB를 사용하면 안 됩니다**
