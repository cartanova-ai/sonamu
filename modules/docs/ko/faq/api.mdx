...
<Info>
**공개 API 만들기**: `guards` 옵션을 생략하면 인증 없이 누구나 접근할 수 있는 공개 API가 됩니다. 로그인이나 권한 체크가 필요 없는 경우에 사용하세요.
</Info>
...
- [API 데코레이터](/api-development/api-decorator)
- [Context와 세션](/api-development/context-session)
- [인증과 권한](/api-development/authentication)
- [에러 처리](/api-development/error-handling)
- [프론트엔드 통합](/frontend-integration/using-services)
