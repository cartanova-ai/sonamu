...
<Accordion title='pnpm dev를 실행했는데 "Port 1028 is already in use" 에러가 발생합니다'>
...
- [프로젝트 시작하기](/getting-started/quick-start)
- [Entity 정의하기](/core-concepts/entities/defining-entities)
- [스캐폴딩 사용하기](/tools-and-cli/scaffolding)
- [마이그레이션 관리](/database/migrations/migration-basics)
