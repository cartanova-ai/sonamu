...
→ [Compress 데코레이터 사용법](/advanced-features/compress/per-api-control)
...
- [compress decorator](/advanced-features/compress/per-api-control) - API별 압축 제어
- [cache-control](/configuration/sonamu-config/cache-control) - 캐시와 압축 함께 사용
- [performance](/troubleshooting/performance/query-optimization) - 성능 최적화
