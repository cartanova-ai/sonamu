...
<Tip>
  각 프론트엔드는 동일한 타입과 Service를 공유하므로, API 변경 시 모든 클라이언트가 자동으로
  업데이트됩니다.
</Tip>
...
<Note>API 전용 프로젝트(예: 마이크로서비스)에서는 동기화를 비활성화할 수 있습니다.</Note>
...
<Card>
  <FileTree>
    <FileItem name="ecommerce/">
      ...
      <FileItem name="web/" description="React 웹 앱">
...
→ [프론트엔드 통합 가이드](/ko/frontend-integration/generated-services/using-services)

## 다음 단계

동기화 대상 설정을 완료했다면:

- [frontend-integration](/ko/frontend-integration/generated-services/how-services-work) - Service 사용법
