...
```json
{
  "timestamp": "2025-01-09T03:34:56.123Z",
  "level": "info",
  "category": ["fastify"],
  "method": "GET",
  "url": "/api/user/list",
...
<CardGroup cols={2}>
  <Card title="카테고리 로깅" icon="folder-tree" href="/ko/configuration/logging/category-logging">
    카테고리 시스템으로 로그를 체계적으로 관리하세요
  </Card>

<Card title="Sinks & Filters" icon="filter" href="/ko/configuration/logging/sinks-and-filters">
  커스텀 Sink와 Filter로 로그 출력을 제어하세요
</Card>

<Card title="LogTape 설정" icon="gear" href="/ko/configuration/logging/logtape-setup">
  기본 로깅 설정과 개념을 학습하세요
</Card>

  <Card title="LogTape 공식 문서" icon="book-open" href="https://github.com/dahlia/logtape">
