...
<CardGroup cols={3}>
  <Card title="pgvector 설정" icon="database" href="/ko/advanced-features/vector-search/pgvector-setup">
    PostgreSQL 벡터 테이블 만들기
  </Card>
  <Card title="벡터 검색" icon="magnifying-glass" href="/ko/advanced-features/vector-search/vector-search">
