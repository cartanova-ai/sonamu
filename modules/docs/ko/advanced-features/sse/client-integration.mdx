...
<CardGroup cols={2}>
  <Card title="SSE 설정" icon="gear" href="/ko/advanced-features/sse/sse-setup">
    SSE 플러그인 설정하기
  </Card>
  <Card title="SSE 엔드포인트 만들기" icon="code" href="/ko/advanced-features/sse/creating-sse-endpoints">
