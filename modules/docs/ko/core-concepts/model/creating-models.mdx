...
<Frame caption="Model Scaffolding"><img src="/modules/docs/images/devWorkflow2.png" alt="Scaffolding" /></Frame>
...
<Tip>
`sonamu.generated.ts`는 Entity 저장 시 자동으로 갱신됩니다. Model을 추가하면 이 파일에도 자동으로 추가됩니다.
</Tip>
