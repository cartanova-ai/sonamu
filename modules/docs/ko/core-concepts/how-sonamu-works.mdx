...
<CardGroup cols={2}>
  ...
  <Card title="Model 이해하기" icon="code" href="/core-concepts/model/what-is-model">
    Model의 역할과 비즈니스 로직 작성 방법을 배워보세요.
  </Card>
  <Card title="자동 생성 메커니즘" icon="wand-magic-sparkles" href="/core-concepts/auto-generation/what-gets-generated">
    어떤 파일들이 자동으로 생성되는지 알아보세요.
  </Card>
  <Card title="타입 시스템" icon="shield" href="/core-concepts/type-system/entity-types">
