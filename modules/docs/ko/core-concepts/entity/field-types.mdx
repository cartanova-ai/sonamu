...
<Info>
**더 알아보기**
- [Enums](/core-concepts/entity/enums) - Enum 상세 가이드
</Info>
...
<Info>
**더 알아보기**
- [Vector Search](/advanced-features/vector-search/setup) - Vector 검색 상세 가이드
...
<Info>
**더 알아보기**
- [Relations](/core-concepts/entity/relations) - Relation 상세 가이드
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Indexes" icon="magnifying-glass" href="/database/migrations/indexes">
    인덱스로 검색 성능 향상하기
  </Card>
  <Card title="Vector Search" icon="brain" href="/advanced-features/vector-search/setup">
    Vector 검색 설정하기
  </Card>
</CardGroup>
