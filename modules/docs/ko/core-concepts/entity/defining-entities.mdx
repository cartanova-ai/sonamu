...
<Info>
**더 알아보기**
- [Field Types](/ko/core-concepts/entity/field-types) - 사용 가능한 모든 데이터 타입
- [Relations](/ko/core-concepts/entity/relations) - Entity 간 관계 정의
</Info>
...
<Info>
**더 알아보기**
- [Sonamu UI 사용하기](/ko/core-concepts/entity/using-sonamu-ui) - UI 상세 가이드
</Info>
