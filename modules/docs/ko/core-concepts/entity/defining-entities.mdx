...
<Note>
Entity는 **Sonamu UI**(`http://localhost:34900/sonamu-ui`)에서 시각적으로 정의하는 것을 권장합니다. Sonamu UI는 자동 완성, 유효성 검사, 실시간 미리보기 기능을 제공합니다.
</Note>
...
<Info>
**더 알아보기**
- [Field Types](/core-concepts/entity/field-types) - 사용 가능한 모든 데이터 타입
- [Relations](/core-concepts/entity/relations) - Entity 간 관계 정의
</Info>
...
<video autoPlay muted loop playsInline controls className="w-full rounded-xl" preload="metadata" src="https://cf.cartanova.ai/sonamu-docs/introduction7.mp4"></video>
</Frame>

<Info>
**더 알아보기**
- [Sonamu UI 사용하기](/core-concepts/entity/using-sonamu-ui) - UI 상세 가이드
</Info>
...
<CardGroup cols={2}>
  <Card title="Sonamu UI 사용하기" icon="browser" href="/core-concepts/entity/using-sonamu-ui">
