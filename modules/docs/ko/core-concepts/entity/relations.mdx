...
| 옵션               | 타입       | 설명                                  | 기본값     |
| ------------------ | ---------- | ------------------------------------- | ---------- |
| `hasJoinColumn`    | boolean    | FK 컬럼 생성 여부                     | _필수_     |
...
| 옵션         | 타입    | 설명                        | 기본값  |
| ------------ | ------- | --------------------------- | ------- |
| `joinColumn` | string  | 상대 테이블의 FK 컬럼명     | _필수_  |
...
| 옵션        | 타입       | 설명                                    | 기본값  |
| ----------- | ---------- | --------------------------------------- | ------- |
| `joinTable` | string     | 중간 테이블명 (`{table1}\_\_${table2}`) | _필수_  |
| `onUpdate`  | RelationOn | 참조 레코드 수정 시 동작                | _필수_  |
| `onDelete`  | RelationOn | 참조 레코드 삭제 시 동작                | _필수_  |
| `nullable`  | boolean    | 관계 자체의 nullable (옵션)             | `false` |
