...
<CardGroup cols={2}>
  <Card title="타입 & 스키마" icon="brackets-curly">
    TypeScript 타입과 Zod 스키마
    
    *.types.ts, sonamu.generated.ts
  </Card>
...
<Info>
**타겟별 생성**: `sonamu.config.ts`의 `sync.targets`에 지정된 각 타겟(`web`, `app` 등)에 복사됩니다.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="When Files Regenerate" icon="clock" href="/ko/core-concepts/auto-generation/when-files-regenerate">
    파일이 언제 재생성되는지 알아보기
  </Card>
  <Card title="Customizing Generated Code" icon="pen-to-square" href="/ko/core-concepts/auto-generation/customizing-generated-code">
    생성된 코드 커스터마이징 방법
  </Card>
