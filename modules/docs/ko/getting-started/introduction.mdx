...
<CardGroup cols={3}>
  ...
  <Card
    title="SSR"
    icon="server"
    href="/ko/frontend-integration/ssr"
  >
    서버 사이드 렌더링
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    title="Fixture 시스템"
    icon="box"
    href="/ko/testing/writing-tests/test-helpers"
  >
    테스트 데이터 관리
  </Card>
...
<CardGroup cols={3}>
  <Card
    title="자세히 보기"
    icon="arrow-right"
    href="/ko/getting-started/seamless-dx"
  >
    Seamless DX 상세 페이지
  </Card>
  <Card
...
<CardGroup cols={2}>
  <Card
    title="BentoCache"
    icon="layer-group"
    href="/ko/advanced-features/caching/bentocache"
  >
    다층 캐싱 전략
  </Card>
  <Card
    title="i18n"
    icon="language"
    href="/ko/advanced-features/i18n/overview"
  >
    다국어 지원 시스템
  </Card>
</CardGroup>
