...
<CardGroup cols={2}>
  <Card title="컴파일 타임 에러" icon="triangle-exclamation" href="/ko/frontend-integration/type-safety/compile-time-errors">
    API 변경 감지
  </Card>
  <Card title="공유 타입" icon="share-nodes" href="/ko/frontend-integration/type-safety/shared-types">
    타입 파일 구조
  </Card>
