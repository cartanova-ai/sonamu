...
<CardGroup cols={2}>
  <Card title="API 타입 추론" icon="wand-magic-sparkles" href="/ko/frontend-integration/type-safety/api-type-inference">
    타입 추론 이해
  </Card>
  ...
  <Card title="테스팅" icon="vial" href="/ko/testing/overview">
    테스트 작성
  </Card>
</CardGroup>
