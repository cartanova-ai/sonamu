...
{ entityId: 'Profile', field: 'id', id: 1 }  # User의 Profile 자동
INSERT IGNORE INTO fixture.profiles (SELECT * FROM production.profiles WHERE id = 1)
INSERT IGNORE INTO fixture.users (SELECT * FROM production.users WHERE id = 1)

{ entityId: 'User', field: 'id', id: 2 }
{ entityId: 'Profile', field: 'id', id: 2 }
INSERT IGNORE INTO fixture.profiles (SELECT * FROM production.profiles WHERE id = 2)
INSERT IGNORE INTO fixture.users (SELECT * FROM production.users WHERE id = 2)

{ entityId: 'User', field: 'id', id: 3 }
{ entityId: 'Profile', field: 'id', id: 3 }
INSERT IGNORE INTO fixture.profiles (SELECT * FROM production.profiles WHERE id = 3)
INSERT IGNORE INTO fixture.users (SELECT * FROM production.users WHERE id = 3)

✅ Import complete! Syncing to test DB...

# 자동으로 fixture sync 실행
```
...
{ entityId: 'User', field: 'id', id: 5 }      # Post의 author
{ entityId: 'Profile', field: 'id', id: 5 }  # User의 Profile
{ entityId: 'Category', field: 'id', id: 10 } # Post의 Category

INSERT IGNORE INTO fixture.profiles (SELECT * FROM production.profiles WHERE id = 5)
INSERT IGNORE INTO fixture.users (SELECT * FROM production.users WHERE id = 5)
INSERT IGNORE INTO fixture.categories (SELECT * FROM production.categories WHERE id = 10)
INSERT IGNORE INTO fixture.posts (SELECT * FROM production.posts WHERE id = 42)
...
```bash
Error: Access denied for user 'readonly'@'%' to database 'fixture'
```
...
<CardGroup cols={2}>
  <Card title="테스트 DB" icon="database" href="/testing/fixtures/test-database">
    테스트 DB 설정
  </Card>
