...
<CardGroup cols={2}>
  <Card title="Automatic Validation" icon="wand-magic-sparkles" href="/api-development/validation/automatic-validation">
  ...
  <Card title="Context" icon="cube" href="/api-development/context">
    SonamuContext
  </Card>
</CardGroup>
