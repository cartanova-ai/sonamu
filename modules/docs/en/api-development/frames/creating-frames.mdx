...
<Info>
Frame URL path is determined by the `frameName` property.
It's converted to lowercase and becomes `/api/{frameName}/{methodName}`.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="What are Frames?" icon="circle-question" href="/en/api-development/frames/what-are-frames">
