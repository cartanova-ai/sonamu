...
<CardGroup cols={2}>
  <Card title="Type Safety" icon="shield">
    Compile-time validation Autocomplete support
  </Card>
  <Card title="Clear Contract" icon="file-contract">
    Auto-generated API spec Client guide
  </Card>
  <Card title="Validation" icon="check-double">
    Automatic type validation Early error detection
  </Card>
  <Card title="Documentation" icon="book">
    Add descriptions with comments Easy maintenance
  </Card>
</CardGroup>
