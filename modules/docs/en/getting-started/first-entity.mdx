...
- The API server must be running at http://localhost:1028.

<Tip>
  When the API server (`pnpm dev`) is running, Sonamu UI is automatically served
  at http://localhost:1028/sonamu-ui.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="link"
    href="/en/core-concepts/entity/relations"
  >
  ...
  <Card
    title="Writing Tests"
    icon="flask"
    href="/en/testing/writing-tests/test-structure"
  >
