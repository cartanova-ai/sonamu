...
<Frame caption="📸 Needed: Running migration in Migration tab"></Frame>
...
<Frame caption="📸 Needed: Generating Model files in Scaffolding tab"></Frame>
...
<Frame caption="📸 Needed: Terminal showing HMR operation logs"></Frame>
...
<Frame caption="📸 Needed: Test execution results in terminal"></Frame>
...
<Frame caption="🎬 Needed: Video demonstrating the above 6 steps (complete process of adding like feature)"></Frame>
