...
<Frame caption="🎬 Writing type-safe queries with Puri - table name, column name autocomplete">
  <video
    autoPlay
    muted
    loop
    ...
    controls
    className="w-full rounded-xl"
    src="/images/introduction-puri.mp4"
  ></video>
</Frame>
...
Supports server-side rendering with Next.js App Router. Improve SEO optimization and initial loading speed.
