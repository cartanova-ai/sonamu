...
<Frame caption="🎬 Needed: Writing type-safe queries with Puri - table name, column name autocomplete"></Frame>
...
<Card title="Puri Guide" icon="database" href="/en/database/puri">
...
Registered routes are rendered on the server and automatically hydrated on the client. Improve SEO optimization and initial loading speed.
...
<CardGroup cols={3}>
  ...
  <Card title="SSR" icon="server" href="/en/frontend-integration/ssr">
...
<CardGroup cols={2}>
  <Card title="Fixture System" icon="box" href="/en/testing/writing-tests/test-helpers">
...
<CardGroup cols={3}>
  <Card title="Learn More" icon="arrow-right" href="/en/getting-started/seamless-dx">
...
<CardGroup cols={2}>
  <Card title="BentoCache" icon="layer-group" href="/en/advanced-features/caching/bentocache">
    Multi-layer caching strategies
  </Card>
  <Card title="i18n" icon="language" href="/en/advanced-features/i18n/overview">
