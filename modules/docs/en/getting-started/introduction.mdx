...
<Frame caption="🎬 Needed: Writing type-safe queries with Puri - table name, column name autocomplete">
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card
    title="SSR"
    icon="server"
    href="/en/frontend-integration/ssr"
  >
...
<CardGroup cols={3}>
  <Card
    title="Learn More"
    icon="arrow-right"
    href="/en/getting-started/seamless-dx"
  >
