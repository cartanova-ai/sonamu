...
<Frame caption="📸 Needed: Browser screen accessing localhost:1028 (default Web app homepage)">
</Frame>

<Frame caption="📸 Needed: Browser screen accessing localhost:1028/api (404 or API response)">
</Frame>

<Frame caption="📸 Needed: Browser screen accessing localhost:1028/sonamu-ui (Sonamu UI dashboard)">
</Frame>
...
<Frame caption="📸 Needed: Sonamu UI main screen (full UI showing Entity tab, Migration tab, etc.)">
</Frame>
