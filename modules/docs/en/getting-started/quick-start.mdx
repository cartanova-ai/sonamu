...
- **Web App**: http://localhost:34900
- **API Endpoints**: http://localhost:34900/api
...
| --------- | -------------------------------- | ---------------------------- |
| Web App   | http://localhost:34900            | Frontend application         |
| API Server| http://localhost:34900/api        | REST API endpoints           |
| Sonamu UI | http://localhost:34900/sonamu-ui  | Entity management interface  |
...
When you access http://localhost:34900/sonamu-ui in your browser, you can perform the following tasks:
