...
<Frame caption="Grouping by Test">
  <img src="/images/vscode-extension11.png" alt="Grouping by Test" style={{ width: '70%', borderRadius: '8px' }} />
</Frame>
...
<Frame caption="Undefined Key Warnings">
  <img src="/images/vscode-extension15.png" alt="Undefined Key Warnings" style={{ width: '70%', borderRadius: '8px' }} />
</Frame>
