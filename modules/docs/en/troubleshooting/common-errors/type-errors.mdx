...
async uploadFile() {
  ...
  // ✅ Access buffer after null check
...
- [Type Checking](/en/configuration/typescript/type-checking)
- [Zod Validation](/en/api-development/validation)
- [Auto-generated Services](/en/frontend-integration/generated-services/how-services-work)
