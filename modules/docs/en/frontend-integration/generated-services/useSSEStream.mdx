...
- [TanStack Query Integration](/en/frontend-integration/generated-services/tanstack-query) - Cache management
- [AI Agents](/en/advanced-features/ai-agents/using-ai-sdk) - AI SDK integration
