...
<CardGroup cols={2}>
  <Card title="API Type Inference" icon="wand-magic-sparkles" href="/en/frontend-integration/type-safety/api-type-inference">
    Understanding type inference
  </Card>
  <Card title="Shared Types" icon="share-nodes" href="/en/frontend-integration/type-safety/shared-types">
    Type file structure
  </Card>
  <Card title="Using Services" icon="code" href="/en/frontend-integration/generated-services/using-services">
    Service usage
  </Card>
  <Card title="Testing" icon="vial" href="/en/testing/overview">
    Writing tests
  </Card>
</CardGroup>
