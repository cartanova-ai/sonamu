...
<CardGroup cols={2}>
  <Card title="압축 설정" icon="gear" href="/advanced-features/compress/compress-configuration">
    전역 압축 플러그인 설정
  </Card>
  <Card title="압축 프리셋" icon="list" href="/advanced-features/compress/compress-presets">
    사전 정의된 압축 설정
  </Card>
  <Card title="API별 제어" icon="code" href="/advanced-features/compress/per-api-control">
    @api 데코레이터에 압축 설정
  </Card>
</CardGroup>
