...
<CardGroup cols={2}>
  <Card title="Compression Configuration" icon="gear" href="/advanced-features/compress/compress-configuration">
    Global compression plugin settings
  </Card>
  <Card title="Compression Presets" icon="list" href="/advanced-features/compress/compress-presets">
    Predefined compression settings
  </Card>
  <Card title="Per-API Control" icon="code" href="/advanced-features/compress/per-api-control">
