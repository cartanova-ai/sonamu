...
<CardGroup cols={2}>
  <Card title="What is Cache-Control?" icon="circle-question" href="/advanced-features/cache-control/what-is-cache-control">
    HTTP caching fundamentals
  </Card>
  <Card title="Cache Presets" icon="list" href="/advanced-features/cache-control/cache-presets">
    Predefined cache configurations
  </Card>
  <Card title="Using in SSR" icon="window" href="/advanced-features/cache-control/using-in-ssr">
