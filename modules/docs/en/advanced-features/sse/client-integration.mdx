...
<Note>
  `useSSEStream` automatically sends the `Accept-Language` header, allowing the server to return
...
<CardGroup cols={2}>
  <Card title="SSE Setup" icon="gear" href="/en/advanced-features/sse/sse-setup">
    Configure the SSE plugin
  </Card>
  <Card
    title="Creating SSE Endpoints"
    icon="code"
    href="/en/advanced-features/sse/creating-sse-endpoints"
  >
