...
```typescript
class TenantServiceModelClass extends BaseModelClass {
  @api()
...
```typescript
class DynamicCacheModelClass extends BaseModelClass {
  @api()
  async getData() {
...
```typescript
class CacheWarmerModelClass extends BaseModelClass {
  async warmupCache() {
...
```typescript
class BatchCacheModelClass extends BaseModelClass {
...
```typescript
class ConditionalCacheModelClass extends BaseModelClass {
  @api()
