...
<CardGroup cols={2}>
  <Card title="Automatic Transactions" icon="wand-magic-sparkles">
    Automatically wraps method execution in transaction
    
    Commits on success, rollbacks on failure
  </Card>
  <Card title="Cleaner Code" icon="broom">
    No need to call transaction()
...
<CardGroup cols={2}>
  <Card title="Constraints" icon="lock">
    Only usable at method level
    
    Partial transactions not possible
  </Card>
  <Card title="Debugging" icon="bug">
    Transaction boundaries are hidden
    
    May be harder to trace issues
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Decorators" icon="at" href="/api-development/decorators">
