...
<Info>
  `getSubsetQueries("P")` returns a query builder (`qb`) with the JOIN and SELECT defined in Subset
  P automatically applied.
</Info>
...
<Tip>
  **Use Subsets!** - Guaranteed type safety - Improved code reusability - Easy maintenance - Query
  consistency
</Tip>
