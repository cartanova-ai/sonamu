...
<Frame>
  <img src="/images/subsets/subset-definition-example.png" alt="Subset definition example in Entity" />
</Frame>
...
<Frame>
  <img src="/images/subsets/subset-performance-comparison.png" alt="Subset performance comparison" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Entity Definition" icon="cube" href="/core-concepts/entity/defining-entities">
