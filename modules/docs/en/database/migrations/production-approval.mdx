...
<Info>
Commenting out the `slackConfirm` block will restore the original behavior (immediate execution without approval).
</Info>
...
<Warning>
Force proceeding logs the reason to the Slack thread. This can be tracked later for audit purposes.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Running Migrations" icon="play" href="/database/migrations/running-migrations">
    Basic execution methods
  </Card>
  <Card title="Rolling Back" icon="rotate-left" href="/database/migrations/rolling-back">
    Undo with migrate rollback
  </Card>
  <Card title="Strategies" icon="chess" href="/database/migrations/migration-strategies">
    Safe migration strategies
  </Card>
  <Card title="How It Works" icon="gear" href="/database/migrations/how-migrations-work">
