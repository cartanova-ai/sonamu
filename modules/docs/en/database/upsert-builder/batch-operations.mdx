...
<CardGroup cols={2}>
  <Card title="Bulk Registration" icon="database">
    Multiple records at once Register with loops
  </Card>
  <Card title="Batch Save" icon="bolt">
    Save with single query Performance optimized
  </Card>
  <Card title="Preserve Relations" icon="link">
    Maintain relationships with UBRef Auto foreign key handling
  </Card>
...
<Info>
  `ubUpsert` processes all registered records with a **single INSERT query** for optimized
  performance.
</Info>
