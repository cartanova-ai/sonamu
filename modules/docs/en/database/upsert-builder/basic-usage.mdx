...
<CardGroup cols={2}>
  <Card title="Transaction Required" icon="arrows-rotate">
    Always used within transactions
  ...
  <Card title="UBRef References" icon="link">
    ...
    Define relationships without IDs
  </Card>
...
<CardGroup cols={2}>
  <Card title="Relational Data" icon="link" href="/database/upsert-builder/relations">
    Handle complex relationships with UBRef
  </Card>
  <Card title="Batch Operations" icon="layer-group" href="/database/upsert-builder/batch-operations">
    Bulk data registration
  </Card>
  <Card title="Advanced Patterns" icon="wand-magic-sparkles" href="/database/upsert-builder/advanced-patterns">
    Complex data structures
  </Card>
  <Card title="Transactions" icon="arrows-rotate" href="/database/transactions">
