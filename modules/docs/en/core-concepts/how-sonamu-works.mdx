...
<Frame caption="🎬 Needed: Animation or video showing the above 4-step flow"></Frame>
...
<Frame caption="📸 Needed: Terminal logs showing HMR in action (file change → invalidate → restart)"></Frame>
