...
| **i18nGenerated** | `src/i18n/**/sd.generated.ts`         | i18n generated files      |

<Info>**File patterns**: Managed in `file-patterns.ts`, change detection via checksum</Info>
...
<AccordionGroup>
  <Accordion title="Files Not Being Generated">
    **Check**: 1. Confirm development server is running 2. Verify file matches watched patterns 3.
    Delete checksum file and retry ```bash rm sonamu.lock pnpm sonamu sync ```
  </Accordion>
