...
<Frame caption="📸 Needed: Sonamu UI main screen - with Entities tab open"></Frame>
...
<Frame caption="📸 Needed: Entity list screen - multiple Entities displayed as cards"></Frame>
...
<Frame caption="📸 Needed: Entity creation dialog - input form screen"></Frame>
...
<Frame caption="📸 Needed: Props sheet screen - property list displayed as table"></Frame>
...
<Frame caption="📸 Needed: Indexes sheet screen"></Frame>
...
<Frame caption="📸 Needed: Subsets sheet screen - selecting fields in tree structure"></Frame>
...
<Frame caption="📸 Needed: Enums section screen - multiple Enums separated by tabs"></Frame>
...
<Frame caption="📸 Needed: Validation error display example"></Frame>
