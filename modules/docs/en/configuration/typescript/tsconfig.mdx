...
- my-project/
  - api/
    - tsconfig.json          # API server configuration
    - tsconfig.schemas.json  # Schema generation
    - tsconfig.types.json    # Type generation
  - web/
    - tsconfig.json          # React app configuration
...
<Tabs>
  ...
  <Tab title="Decorators" icon="sparkles">
    ...
    **Usage Example:**
    ...
    <Info>
    Entities are defined in `entity.json` files and do not use TypeScript decorators. See [Defining Entities](/core-concepts/entity/defining-entities) for details.
    </Info>
  </Tab>
  ...
  <Tab title="Strict Mode" icon="shield-check">
    ...
    See [Type Checking](/configuration/typescript/type-checking) for details.
  </Tab>
...
See [Path Mapping](/configuration/typescript/path-mappings) for details.
