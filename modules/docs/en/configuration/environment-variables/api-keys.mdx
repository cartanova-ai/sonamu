...
<Info>
  These services are not part of Sonamu's default configuration. Add them only when needed for your
  project.
</Info>
...
<Tab title="SendGrid" icon="envelope">
  ```bash # SendGrid Email SENDGRID_API_KEY=your-sendgrid-api-key
...
<Step title="Create API Key" icon="key">
  1. API keys → Create new secret key 2. Name: `sonamu-production` 3. Permissions: **All** or
...
<Card title="Storage Configuration" icon="cloud" href="/en/configuration/sonamu-config/storage">
  Configure S3 storage
</Card>

  <Card title="Session Settings" icon="shield" href="/en/configuration/sonamu-config/server">
