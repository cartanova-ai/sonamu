...
<Tabs>
  ...
  <Tab title="Production" icon="server">
    ...
    **Read Replica Configuration (optional):**
    ...
    <Info>
    Sonamu automatically recognizes the `environments.production_slave` configuration and uses it for read-only queries. See [Database Configuration](/configuration/sonamu-config/database) for details.
    </Info>
  </Tab>
</Tabs>
