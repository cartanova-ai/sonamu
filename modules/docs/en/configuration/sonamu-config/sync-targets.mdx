...
<FileTree>
  <FileItem name="ecommerce/">
    ...
    <FileItem name="web/" description="Next.js web app">
...
→ [Frontend Integration Guide](/frontend-integration/generated-services/using-services)

## Next Steps

After completing sync target configuration:

- [frontend-integration](/frontend-integration/generated-services/how-services-work) - How to use Services
