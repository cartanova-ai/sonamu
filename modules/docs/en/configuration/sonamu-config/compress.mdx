...
→ [Compress Decorator Usage](/advanced-features/compress/per-api-control)
...
- [compress decorator](/advanced-features/compress/per-api-control) - Per-API compression control
- [cache-control](/configuration/sonamu-config/cache-control) - Using cache with compression
- [performance](/troubleshooting/performance/query-optimization) - Performance optimization
