...
**noAuth (authentication not required):**
```typescript
@api({
  httpMethod: "GET",
  noAuth: true  // Accessible without login
})
async publicApi() { }
```
...
- [API Decorator](/api-development/api-decorator)
- [Context and Session](/api-development/context-session)
- [Authentication and Authorization](/api-development/authentication)
- [Error Handling](/api-development/error-handling)
- [Frontend Integration](/frontend-integration/using-services)
