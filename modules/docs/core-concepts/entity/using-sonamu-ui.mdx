...
<Frame caption="📸 필요: Sonamu UI 메인 화면 - Entities 탭이 열린 상태">
</Frame>
...
<Frame caption="📸 필요: Entity 목록 화면 - 여러 Entity가 카드 형태로 나열">
</Frame>
...
<Frame caption="📸 필요: Entity 생성 다이얼로그 - 입력 폼 화면">
</Frame>
...
<Frame caption="📸 필요: Props 시트 화면 - 속성 목록이 표 형태로 표시">
</Frame>
...
<Frame caption="📸 필요: Indexes 시트 화면">
</Frame>
...
<Frame caption="📸 필요: Subsets 시트 화면 - 트리 구조로 필드 선택">
</Frame>
...
<Frame caption="📸 필요: Enums 섹션 화면 - 여러 Enum이 탭으로 구분">
</Frame>
...
<Frame caption="📸 필요: 유효성 검사 오류 표시 예제">
</Frame>
