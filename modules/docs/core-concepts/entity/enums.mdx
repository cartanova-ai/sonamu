...
<CardGroup cols={2}>
  <Card title="타입 안전성" icon="shield-check">
    ...
    TypeScript에서 Union 타입으로 자동 변환
  </Card>
  <Card title="UI 자동 생성" icon="list">
    선택 목록 자동 구성
    
    Select, ButtonSet 컴포넌트에 즉시 사용
  </Card>
...
<Frame caption="📸 필요: Sonamu UI의 Enums 섹션 - 여러 Enum이 탭으로 구분되어 표시">
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Validation" icon="shield-check" href="/api-development/validation/zod-schemas">
    Zod로 데이터 검증하기
  </Card>
  <Card title="Frontend Components" icon="browser" href="/frontend-integration/generated-services/using-services">
    생성된 컴포넌트 사용하기
  </Card>
  <Card title="API Development" icon="code" href="/api-development/creating-apis/basic-crud">
    Enum을 사용한 API 개발
  </Card>
</CardGroup>
