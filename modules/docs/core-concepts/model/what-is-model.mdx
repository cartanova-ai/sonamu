...
<Info>
Model은 API Layer와 Database 사이의 **비즈니스 로직 레이어**입니다. 모든 데이터 접근과 비즈니스 규칙은 Model에서 처리됩니다.
</Info>
...
<Tip>
이 제네릭 타입들은 `sonamu.generated.ts`와 `sonamu.generated.sso.ts`에서 자동으로 생성되므로 직접 작성할 필요가 없습니다.
</Tip>
...
<Info>
**더 알아보기**
- [BaseModel Methods](/core-concepts/model/basemodel-methods) - 메서드 상세 가이드
</Info>
...
<CardGroup cols={2}>
  <Card title="Creating Models" icon="plus" href="/core-concepts/model/creating-models">
    Model 생성하고 Scaffold 사용하기
  </Card>
  <Card title="API Decorator" icon="at" href="/core-concepts/model/api-decorator">
    @api 데코레이터로 API 엔드포인트 만들기
  </Card>
  <Card title="Business Logic" icon="lightbulb" href="/core-concepts/model/business-logic">
    비즈니스 로직 작성 패턴과 예제
  </Card>
  <Card title="BaseModel Methods" icon="book" href="/core-concepts/model/basemodel-methods">
