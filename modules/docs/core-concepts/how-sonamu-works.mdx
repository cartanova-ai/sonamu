...
<Frame caption="📸 필요: Syncer 작동 흐름도 (파일 변경 감지 → 코드 생성 → 동기화)">
</Frame>
...
<Frame caption="🎬 필요: 위 4단계 플로우를 실제로 보여주는 애니메이션 또는 영상">
</Frame>
...
<Frame caption="📸 필요: HMR 동작하는 터미널 로그 (파일 변경 → invalidate → 재시작)">
</Frame>
