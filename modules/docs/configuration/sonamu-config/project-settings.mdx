...
- [database](/configuration/sonamu-config/database) - 데이터베이스 연결 설정
- [server](/configuration/sonamu-config/server) - 서버 옵션 및 플러그인 설정
- [sync-targets](/configuration/sonamu-config/sync-targets) - 프론트엔드 동기화 대상 설정
