    ...
    <div className="w-full">
      <div
        className={classNames(
          "flex items-center group px-1.5 py-1 rounded-md cursor-pointer transition-colors duration-150",
      ...
      >
        ...
        <div className="mr-1.5 shrink-0">
          {node.type === "directory" ? (
            expanded ? (
              <FolderOpenIcon
                className={classNames("w-3.5 h-3.5", isActive ? "text-blue-600" : "text-gray-400")}
              />
            ) : (
              <FolderIcon
                className={classNames("w-3.5 h-3.5", isActive ? "text-blue-600" : "text-gray-400")}
