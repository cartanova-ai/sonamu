...
export const CompanyMigrationTestEntity = new Entity({
  id: "Company",
  table: "companies",
...
export const ProfileMigrationTestEntity = new Entity({
  id: "Profile",
  table: "profiles",
...
export const PostMigrationTestEntity = new Entity({
  id: "Post",
  table: "posts",
...
export const TagMigrationTestEntity = new Entity({
  id: "Tag",
  table: "tags",
...
export const MigrationSetTestEntity = new Entity({
  id: "MigrationSetTest",
  ...
  props: [
    ...
    // 4. virtual컬럼 테스트
    { name: "test_virtual_prop", type: "virtual", id: "TestVirtual", desc: "테스트 virtual 컬럼" },
  ],
  indexes: [
    ...
    { type: "index", columns: ["test_string_col", "test_integer_nullable"], name: "idx_composite" },
  ],
  subsets: {},
  enums: {
