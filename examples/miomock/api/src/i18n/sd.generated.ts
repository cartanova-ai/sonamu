...
const entityLabels = {
  ...
  "entity.Company.list": "COMPANY 목록",
  "entity.Company.create": "COMPANY 생성",
  "entity.Company.edit": (id: number) => `COMPANY 수정 (#${id})`,
  ...
  "entity.Department.list": "부서 목록",
  "entity.Department.create": "부서 생성",
  "entity.Department.edit": (id: number) => `부서 수정 (#${id})`,
  ...
  "entity.Document.list": "DOCUMENT 목록",
  "entity.Document.create": "DOCUMENT 생성",
  "entity.Document.edit": (id: number) => `DOCUMENT 수정 (#${id})`,
  ...
  "entity.Employee": "직원",
  "entity.Employee.list": "직원 목록",
  "entity.Employee.create": "직원 생성",
  "entity.Employee.edit": (id: number) => `직원 수정 (#${id})`,
  ...
  "entity.File": "FILE",
  "entity.File.list": "FILE 목록",
  "entity.File.create": "FILE 생성",
  "entity.File.edit": (id: number) => `FILE 수정 (#${id})`,
  "entity.File.id": "ID",
  ...
  "entity.Project.list": "PROJECT 목록",
  "entity.Project.create": "PROJECT 생성",
  "entity.Project.edit": (id: number) => `PROJECT 수정 (#${id})`,
  ...
  "entity.SyncFixture.list": "Syncer 테스트 픽스처 목록",
  "entity.SyncFixture.create": "Syncer 테스트 픽스처 생성",
  "entity.SyncFixture.edit": (id: number) => `Syncer 테스트 픽스처 수정 (#${id})`,
  ...
  "entity.Tag": "TAG",
  "entity.Tag.list": "TAG 목록",
  "entity.Tag.create": "TAG 생성",
  "entity.Tag.edit": (id: number) => `TAG 수정 (#${id})`,
  "entity.Tag.id": "ID",
  ...
  "entity.User": "USER",
  "entity.User.list": "USER 목록",
  "entity.User.create": "USER 생성",
  "entity.User.edit": (id: number) => `USER 수정 (#${id})`,
  "entity.User.id": "ID",
