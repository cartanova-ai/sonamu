...
const entityLabels = {
  ...
  "entity.Post": "POST",
  "entity.Post.id": "ID",
  "entity.Post.created_at": "등록일시",
  "entity.Post.title": "TITLE",
  "entity.Post.content": "CONTENT",
  "entity.Post.author": "AUTHOR",
  "enum.PostOrderBy.id-desc": "ID최신순",
  "enum.PostSearchField.id": "ID",
