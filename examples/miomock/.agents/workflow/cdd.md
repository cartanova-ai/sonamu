...
- Both `cdd-test-writer` and `cdd-implementer` must re-route missing shared surface or migration-prerequisite findings to `cdd-surface-scaffolder` instead of inventing or broadening their own scope.
